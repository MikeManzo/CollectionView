...
fileprivate class LayoutTester: CollectionViewDataSource, CollectionViewDelegateListLayout {
    func collectionView(_ collectionView: CollectionView, willDisplaySupplementaryView view: CollectionReusableView, ofElementKind elementKind: String, at indexPath: IndexPath) {
